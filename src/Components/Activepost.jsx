...
function Activepost() {
    ...
    async function fetchBlogs() {
        try {
            ...
            let filterBlogs = res.documents.filter((item) => item.status == 'active')
  ...
  return (
    ...
    {data.length > 0 ? (
      ...
      <>
       <div className='w-[93vw] flex items-center justify-center'>
  <div className="flex w-[70vw] flex-col items-center justify-center min-h-[60vh]  p-6 rounded-lg shadow-md">
  <svg
